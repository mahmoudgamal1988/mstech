...
export const caseStudy = {
  ...
  summary: [
    'We develop smart solutions that enable you to understand your customers and analyze their behavior to provide an exceptional experience, improve your sales, and increase operational efficiency.',
  ],
  logo,
  image: { src: imageHero },
  date: '2022-06',
