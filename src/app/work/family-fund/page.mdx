...
export const caseStudy = {
  ...
  summary: [
    'Control your home appliances with one click by connecting various home devices and systems together and controlling them from anywhere (know more hyperlink to Huem page).',
  ],
  logo,
  image: { src: imageHero },
  date: '2023-01',
